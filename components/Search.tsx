            ...
            <div className="w-full max-w-xl bg-slate-900 border border-slate-700 rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="p-4 border-b border-slate-800 flex items-center space-x-3">
                    ...
                    <input
                        autoFocus
                        type="text"
                        placeholder="Buscar anotação (ex: @Service, @Autowired...)"
                ...
                <div className="max-h-[60vh] overflow-y-auto p-2">
                    {filteredResults.length > 0 ? (
                        ...
                        <div className="py-8 text-center">
                            <p className="text-slate-400 text-sm font-medium">Digite para buscar</p>
                            <p className="text-slate-500 text-[11px] mt-1">Todas as anotações do Spring Framework num só lugar</p>
                        </div>
                    )}
                </div>
                ...
                <div className="p-3 bg-slate-950/50 border-t border-slate-800 flex justify-between items-center text-[10px] text-slate-500 uppercase tracking-widest">
                    <span>{allAnnotations.length} anotações mapeadas</span>
